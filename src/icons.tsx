import { Icons, JSX, ReflectionKind } from 'typedoc';

/**
 * Get the icons for this theme.
 */
export function getThemeIcons(): Partial<Icons> {
    return {
        search: () => (
            <svg class="tsd-kind-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                <path
                    fill="#0288d1"
        ...
        [ReflectionKind.TypeAlias]: () => (
            <svg class="tsd-kind-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                <path
                    fill="#0288d1"
